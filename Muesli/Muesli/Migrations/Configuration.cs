namespace Muesli.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Muesli.DAL.BreakfastContext>
    {
        ...
        protected override void Seed(Muesli.DAL.BreakfastContext context)
        {
            ...
            context.Ingredients.AddOrUpdate(
                ...
                new Ingredient() { IngredientId = 3, Name = "Wheat", Price = 0.03m },
                new Ingredient() { IngredientId = 4, Name = "Corn", Price = 0.04m },
                new Ingredient() { IngredientId = 5, Name = "Barley", Price = 0.05m },
                new Ingredient() { IngredientId = 6, Name = "Rice", Price = 0.06m },
                new Ingredient() { IngredientId = 7, Name = "Pineapple", Price = 0.07m }, // fruit category: 14 items
                new Ingredient() { IngredientId = 8, Name = "Banana", Price = 0.08m },
                new Ingredient() { IngredientId = 9, Name = "Dates", Price = 0.09m },
                new Ingredient() { IngredientId = 10, Name = "Cherry", Price = 0.10m },
                new Ingredient() { IngredientId = 11, Name = "Melon", Price = 0.11m },
                new Ingredient() { IngredientId = 12, Name = "Apple", Price = 0.12m },
                new Ingredient() { IngredientId = 13, Name = "Raisins", Price = 0.13m },
                new Ingredient() { IngredientId = 14, Name = "Cranberries", Price = 0.14m },
                new Ingredient() { IngredientId = 15, Name = "Peach", Price = 0.15m },
                new Ingredient() { IngredientId = 16, Name = "Orange", Price = 0.16m },
                new Ingredient() { IngredientId = 17, Name = "Grapefruit", Price = 0.17m },
                new Ingredient() { IngredientId = 18, Name = "Mango", Price = 0.18m },
                new Ingredient() { IngredientId = 19, Name = "Papaya", Price = 0.19m },
                new Ingredient() { IngredientId = 20, Name = "Plum", Price = 0.20m },
                new Ingredient() { IngredientId = 21, Name = "Cashew", Price = 0.21m }, // nut category: 6 items
                new Ingredient() { IngredientId = 22, Name = "Brazil", Price = 0.22m },
                new Ingredient() { IngredientId = 23, Name = "Walnut", Price = 0.23m },
                new Ingredient() { IngredientId = 24, Name = "Hazelnut", Price = 0.24m },
                new Ingredient() { IngredientId = 25, Name = "Almond", Price = 0.25m },
                new Ingredient() { IngredientId = 26, Name = "Peanut", Price = 0.26m },
                new Ingredient() { IngredientId = 27, Name = "Linseed", Price = 0.27m }, // seed category: 7 items
                new Ingredient() { IngredientId = 28, Name = "Sesam", Price = 0.28m },
                new Ingredient() { IngredientId = 29, Name = "Chia", Price = 0.29m },
                new Ingredient() { IngredientId = 30, Name = "Pumpkin", Price = 0.30m },
                new Ingredient() { IngredientId = 31, Name = "Sunflower", Price = 0.31m },
                new Ingredient() { IngredientId = 32, Name = "Poppy", Price = 0.32m },
                new Ingredient() { IngredientId = 33, Name = "Cannabis", Price = 0.33m },
                new Ingredient() { IngredientId = 34, Name = "Cinnamon", Price = 0.34m }, // others category: 3 items
                new Ingredient() { IngredientId = 35, Name = "Chocolate", Price = 0.35m },
                new Ingredient() { IngredientId = 36, Name = "Ginger", Price = 0.36m } // total:  36 items
                );
            ...
            context.Ingredient_Categories.AddOrUpdate(
                     new Ingredient_Category() { IngredientId = 1, CategoryId = 1 },
                     new Ingredient_Category() { IngredientId = 2, CategoryId = 1 },
                     new Ingredient_Category() { IngredientId = 3, CategoryId = 1 },
                     new Ingredient_Category() { IngredientId = 4, CategoryId = 1 },
                     new Ingredient_Category() { IngredientId = 5, CategoryId = 1 },
                     new Ingredient_Category() { IngredientId = 6, CategoryId = 1 }, // iki cia
                     new Ingredient_Category() { IngredientId = 7, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 8, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 9, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 10, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 11, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 12, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 13, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 14, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 15, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 16, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 17, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 18, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 19, CategoryId = 2 },
                     new Ingredient_Category() { IngredientId = 20, CategoryId = 2 }, // iki cia
                     new Ingredient_Category() { IngredientId = 21, CategoryId = 3 },
                     new Ingredient_Category() { IngredientId = 22, CategoryId = 3 },
                     new Ingredient_Category() { IngredientId = 23, CategoryId = 3 },
                     new Ingredient_Category() { IngredientId = 24, CategoryId = 3 },
                     new Ingredient_Category() { IngredientId = 25, CategoryId = 3 },
                     new Ingredient_Category() { IngredientId = 26, CategoryId = 3 }, // iki cia
                     new Ingredient_Category() { IngredientId = 27, CategoryId = 4 },
                     new Ingredient_Category() { IngredientId = 28, CategoryId = 4 },
                     new Ingredient_Category() { IngredientId = 29, CategoryId = 4 },
                     new Ingredient_Category() { IngredientId = 30, CategoryId = 4 },
                     new Ingredient_Category() { IngredientId = 31, CategoryId = 4 },
                     new Ingredient_Category() { IngredientId = 32, CategoryId = 4 },
                     new Ingredient_Category() { IngredientId = 33, CategoryId = 4 }, // iki cia
                     new Ingredient_Category() { IngredientId = 34, CategoryId = 5 },
                     new Ingredient_Category() { IngredientId = 35, CategoryId = 5 },
                     new Ingredient_Category() { IngredientId = 36, CategoryId = 5 }
                     );
            ...
            context.Users.AddOrUpdate(
                 new User() { UserId = 1, Username = "user1", FirstName = "UserFirstName1", LastName = "UserLastName1", Email = "email1@gmail.com", Password = "magic6", Address = "Fake street 1", ZipCode = "8001", City = "Aarhus" },
                 new User() { UserId = 2, Username = "user2", FirstName = "UserFirstName2", LastName = "UserLastName2", Email = "email2@gmail.com", Password = "magic6", Address = "Fake street 2", ZipCode = "8002", City = "Aarhus" },
                 new User() { UserId = 3, Username = "user3", FirstName = "UserFirstName3", LastName = "UserLastName3", Email = "email3@gmail.com", Password = "magic6", Address = "Fake street 3", ZipCode = "8003", City = "Aarhus" },
                 new User() { UserId = 4, Username = "user4", FirstName = "UserFirstName4", LastName = "UserLastName4", Email = "email4@gmail.com", Password = "magic6", Address = "Fake street 4", ZipCode = "8004", City = "Aarhus" },
                 new User() { UserId = 5, Username = "user5", FirstName = "UserFirstName5", LastName = "UserLastName5", Email = "email5@gmail.com", Password = "magic6", Address = "Fake street 5", ZipCode = "8005", City = "Aarhus" },
