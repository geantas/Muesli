    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Muesli.DAL.BreakfastContext>
    {
        ...
        protected override void Seed(Muesli.DAL.BreakfastContext context)
        {
         ...
         /*   var ingredients = new List<Ingredient> {
            ...
            {
                new User{UserId=1, Username="user1",FirstName="UserFirstName1",LastName="UserLastName1",Email="email1@gmail.com"},
                new User{UserId=2,Username="user2",FirstName="UserFirstName2",LastName="UserLastName2",Email="email2@gmail.com"},
                new User{UserId=3,Username="user3",FirstName="UserFirstName3",LastName="UserLastName3",Email="email3@gmail.com"},
                new User{UserId=4,Username="user4",FirstName="UserFirstName4",LastName="UserLastName4",Email="email4@gmail.com"},
                new User{UserId=5,Username="user5",FirstName="UserFirstName5",LastName="UserLastName5",Email="email5@gmail.com"},
                new User{UserId=6,Username="user6",FirstName="UserFirstName6",LastName="UserLastName6",Email="email6@gmail.com"},
                new User{UserId=7,Username="user7",FirstName="UserFirstName7",LastName="UserLastName7",Email="email7@gmail.com"},
                new User{UserId=8,Username="user8",FirstName="UserFirstName8",LastName="UserLastName8",Email="email8@gmail.com"},
                new User{UserId=9,Username="user9",FirstName="UserFirstName9",LastName="UserLastName9",Email="email9@gmail.com"}
            };
